<!-- Base Usage -->
<!--
<set-field class="white-txt" v-model="options">Caption</set-field>
-->
<template>
  <fieldset class="form-control inline-block p-0 relative">
    ...
    <div class="flex-start-center border-light rounded-3 white-bg-1">
      <label draggable="true"
        ...
        <button class="absolute p-0 white-bg border-none rounded cursor-pointer"
                v-on:click="remove(index)">✕</button>
